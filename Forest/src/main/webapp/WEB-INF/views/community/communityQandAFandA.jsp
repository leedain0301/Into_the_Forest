      ...
      <div class="table mb-4">
              ...
              <div class="d-flex">
                ...
                <div class="me-4">
                  <div class="input-label-absolute input-label-absolute-right">
                    ...
                    <input class="form-control pe-5" type="search" name="search" placeholder="검색어를 입력해주세요."
                      id="form_search">
                  </div>
                </div>
                <div class="float-end">
        ...
        <table class="table text-gray-800 table-striped table-hover">
          ...
          <tr>
            ...
            <td class="py-4 w-50 align-" colspan="2">
              1 : 1문의 답변 시간은 어떻게 되나요?</td>
