  ...
  <section class="pb-6 mt-5 ">
      ...
      <div class="row">
        ...
        <div class="col-xl-3">
          <select class="selectpicker form-control" name="category" id="category" data-style="btn-selectpicker"
            ...
            <option value="category_0">산 </option>
            <option value="category_1">휴양림</option>
            <option value="category_2">둘레길</option>
            <option value="category_3">자전거길</option>
          </select>
        </div>
        <div class="col-xl-6">
          <div class="input-group">
            <input class="form-control" type="text" placeholder="검색어를 입력해주세요." id="form_search">
    ...
    <div class="container">
      <div class="row mb-5">
        ...
        <div class="col-lg-4 col-sm-6 mb-4 hover-animate">
          <div class="card shadow border-0 h-100">
            <!--<a href="post.html"><img class="img-fluid card-img-top" src="img/4윤정희/계룡산.png" alt="..." /></a>-->
            <a href="post.html"><img class="img-fluid card-img-top avatar-lg" src="${path }/resources/img/community2.png" alt="..."
                style="width: 100%; height: 12rem; object-fit: cover;" /></a>
            <div class="card-body"><a class="text-uppercase text-muted text-sm letter-spacing-2" href="#">산 </a>
              <h5 class="my-2"><a class="text-dark" href="post.html">100대 명산 계룡산 등산 후기</a></h5>
              <p class="text-gray-500 text-sm my-3"><i class="far fa-clock me-2"></i>2020.09.28 <i class="me-4"></i><i
                  class="fas fa-user me-2"></i>RiverWind JH-Jung</p>
              <p class="my-2 text-muted text-sm">계룡산 동학사 입구 소형주차장 출발 원점회귀 코스입니다. 한여름 무더운 날씨이지만 계곡을 들어서면 냉기가 느껴질 만큼 동학사
                계곡은...</p><a class="btn btn-link ps-0" href="post.html">Read more<i
                  class="fa fa-long-arrow-alt-right ms-2"></i></a>
              <!--후기링크 https://fmtview.com/249-->
            </div>
          </div>
        </div>
        <!-- blog item-->
        ...
        <div class="col-lg-4 col-sm-6 mb-4 hover-animate">
          <div class="card shadow border-0 h-100">
            <a href="post.html"><img class="img-fluid card-img-top" src="${path }/resources/img/4윤정희/휴양림후기.jpg" alt="..." /></a>
            <div class="card-body"><a class="text-uppercase text-muted text-sm letter-spacing-2" href="#">휴양림 </a>
              <h5 class="my-2"><a class="text-dark" href="post.html">구례 산수유 자연휴양림 숲속의집 반야봉 솔직후기</a></h5>
              <p class="text-gray-500 text-sm my-3"><i class="far fa-clock me-2"></i>2022.02.06 <i class="me-4"></i><i
                  class="fas fa-user me-2"></i>SunSir</p>
              <p class="my-2 text-muted text-sm">눈 내리는 추운날, 구례 산수유 자연휴양림에서 푹~ 쉬고 왔답니다. 온라인으로 예약하면 입실 하루 전에 안내문자가 발송돼요.
                빠르고 평탄한...</p><a class="btn btn-link ps-0" href="post.html">Read more<i
                  class="fa fa-long-arrow-alt-right ms-2"></i></a>
              <!--후기링크 https://m.blog.naver.com/sunkim00412/222640015505-->
            </div>
          </div>
        </div>
        <div class="col-lg-4 col-sm-6 mb-4 hover-animate">
          <div class="card shadow border-0 h-100">
            <a href="post.html"><img class="img-fluid card-img-top" src="${path }/resources/img/4윤정희/서울둘레길.png" alt="..." /></a>
            <div class="card-body"><a class="text-uppercase text-muted text-sm letter-spacing-2" href="#">둘레길 </a>
              <h5 class="my-2"><a class="text-dark" href="post.html">서울둘레길 네 차례 완주한 코스별 후기 </a></h5>
              <p class="text-gray-500 text-sm my-3"><i class="far fa-clock me-2"></i>2018.04.19 <i class="me-4"></i><i
                  class="fas fa-user me-2"></i>sunshine2</p>
        ...
        <div class="col-lg-4 col-sm-6 mb-4 hover-animate">
          <div class="card shadow border-0 h-100">
            <a href="post.html"><img class="img-fluid card-img-top" src="${path }/resources/img/4윤정희/한라산.png" alt="..." /></a>
            <div class="card-body"><a class="text-uppercase text-muted text-sm letter-spacing-2" href="#">산 </a>
              <h5 class="my-2"><a class="text-dark" href="post.html">[한라산 백록담]등산초보의 한라산 성판악코스 등반후기</a></h5>
              <p class="text-gray-500 text-sm my-3"><i class="far fa-clock me-2"></i>2021.04.10 <i class="me-4"></i><i
                  class="fas fa-user me-2"></i>2jelly</p>
        ...
        <div class="col-lg-4 col-sm-6 mb-4 hover-animate">
          <div class="card shadow border-0 h-100">
            <a href="post.html"><img class="img-fluid card-img-top" src="${path }/resources/img/4윤정희/계룡산.png" alt="..." /></a>
            <div class="card-body"><a class="text-uppercase text-muted text-sm letter-spacing-2" href="#">산 </a>
              <h5 class="my-2"><a class="text-dark" href="post.html">100대 명산 계룡산 등산 후기</a></h5>
              <p class="text-gray-500 text-sm my-3"><i class="far fa-clock me-2"></i>2020.09.28 <i class="me-4"></i><i
                  class="fas fa-user me-2"></i>RiverWind JH-Jung</p>
