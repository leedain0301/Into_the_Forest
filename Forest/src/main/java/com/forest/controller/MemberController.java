...
import com.forest.member.model.service.MemberService;
...
public class MemberController {
	...
	public ModelAndView update(ModelAndView model, @ModelAttribute Member member, // @ModelAttribute 생략 가능!
...
//	}
	...
	public ModelAndView updatePwd(ModelAndView model,
			@SessionAttribute(name = "loginMember", required = false) Member loginMember, String userPwd) {
